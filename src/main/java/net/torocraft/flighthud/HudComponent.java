...
public abstract class HudComponent extends DrawableHelper {
    ...
    protected void drawRightAlignedFont(MinecraftClient mc, MatrixStack m, String s, float x, float y) {
    ...
    protected void drawHorizontalLineDashed(MatrixStack m, float x1, float x2, float y, int dashCount) {
        float width = x2 - x1;
